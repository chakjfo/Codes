...
public class LuxuryRoom extends javax.swing.JFrame {
    ...
    public LuxuryRoom(Date checkInDate, Date checkOutDate, String roomType, double totalPrice) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LuxuryRoom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
