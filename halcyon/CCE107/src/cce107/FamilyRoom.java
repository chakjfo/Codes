 ...
 * @author chari
 */
public class FamilyRoom extends javax.swing.JFrame {

    /**
     * Creates new form FamilyRoom
     */
    ...
    public FamilyRoom(Date checkInDate, Date checkOutDate, String roomType, double totalPrice) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FamilyRoom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
